...
<head>
    ...
    <style>
        body {
            background: radial-gradient(ellipse at top, #1a0a2e 0%, #0f172a 50%);
        }
...
<body class="min-h-screen text-white overflow-x-hidden">
    ...
    <section class="relative z-10 pt-32 pb-20 px-4 text-center">
        <div class="max-w-4xl mx-auto">
            <div
                class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-medium mb-6 tracking-wide uppercase">
    ...
    <section class="relative z-10 py-16 px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach ([['1', 'Create a Game', 'Set the gift budget, join deadline, and meeting date.', '🎮'], ['2', 'Invite Friends', 'Share the unique link — anyone with it can join.', '🔗'], ['3', 'Assignments', 'After the deadline, hit \'Assign\' to pair everyone up.', '🎯'], ['4', 'Reveal', 'Each participant visits the link to see who they\'re gifting.', '🎁']] as [$step, $title, $desc, $icon])
                    <div class="feature-card rounded-2xl p-6 text-center">
                        <div
                            class="w-10 h-10 rounded-full bg-red-500/20 text-red-400 text-sm font-bold flex items-center justify-center mx-auto mb-3">
                            {{ $step }}</div>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="feature-card rounded-3xl p-8 sm:p-12 text-center glow-gold">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 text-left">
                    @foreach ([['📝', 'Enter Names', 'Type in everyone attending the party.'], ['📱', 'Pass Device', 'Each person taps their name to see their match.'], ['🤫', 'Keep Secret', 'Only they see their assignment on screen.']] as [$icon, $title, $desc])
