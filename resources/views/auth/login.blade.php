...
@section('content')
    ...
    <a href="{{ route('auth.google') }}"
       class="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-xl border border-slate-600 hover:border-slate-400 bg-slate-700/50 hover:bg-slate-700 text-white text-sm font-medium transition-all mb-5">
    ...
    <div class="relative my-5">
        ...
        <div class="relative text-center"><span class="px-3 bg-slate-800 text-slate-500 text-xs">or with email</span></div>
    </div>
...
@section('footer-link')
    ...
    <a href="{{ route('register') }}" class="text-amber-400 hover:text-amber-300 font-medium ml-1">Create one</a>
@endsection
